...
5.7. **Gate Chain Pre-check**（clade fork addition — per [[verify-gate-chain]]）
   ...
   讀 consumer 的 `.cursor/rules/local/verify-commands.mdc`。若不存在 → skip（note "No verify-commands.md, gate chain skipped"）。
