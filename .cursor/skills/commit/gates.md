...
2. 萃取本次 commit scope 涉及的 spectra change（staged-delete **或** working tree 殘留不完整 change dir，**排除** archive 子目錄）：
   ...
   #    intent source、tasks.md 是生成的），兩檔條件對它恆真 —— <consumer-b> 在 main 的每一次
