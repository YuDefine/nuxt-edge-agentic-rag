...
| <consumer-g>（分母沒收斂：14 檔請求 → 6,330） | $15 只推進 22/6,330，線性外推整個 repo ≈ $4,300 USD |
| <consumer-a> / <consumer-g> 合計 | 16 次，0 次成功 |
...
**同一次 commit 已經被 CI-only 失敗打回過第二次**時，別再逐發修——**MUST** 讀 `~/offline/clade/vendor/snippets/ci-parity/`，它有本機重現 CI 條件的 checklist 與兩個 consumer 的實際 churn 案例（<consumer-a> 曾為此連發六個修復 commit）。
