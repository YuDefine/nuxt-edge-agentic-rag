...
import { appendRecord } from '../signals/ledger-writer.mts'
import { aggregateConsumerSignals } from './aggregate-signals.mts'
import {
  computeLayeredMetrics,
  inferAllClosures,
  readJsonl as readJsonlScanner,
} from './closure-scanner.mts'
import { isClosedStatus, parseTechDebtStatus } from './tech-debt-status.mts'
