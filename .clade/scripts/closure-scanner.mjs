...
import { getTechDebtStatus, isClosedStatus } from './tech-debt-status.mjs'
...
export function inferClosure(
  candidate,
  { repoRoot = CLADE_ROOT, since = '90 days ago', explicitRefs } = {},
) {
...
export function inferAllClosures(candidates, options = {}) {
