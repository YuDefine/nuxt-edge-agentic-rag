...
// session that rewrites the same section from its own buffer. Measured 2026-08-29 on <consumer-g> span
 ...
 * narrating it — a substring search finds it and the loss reads as filed. Measured on <consumer-g>
