 ...
 * Measured 2026-08-29 on <consumer-g> `ee92949d75fa703c`: three writes, zero survivors, found two hours
...
export function findUnfiledAnswerStalls(
  ...
  for (const span of spans) {
    ...
    // it, and no landing block was ever written or wanted. Measured on <consumer-g> 2026-08-29: 54 of the
