...
- 來源 MD：`local/reports/archive/main-v0.0.52.md`
- 生成時間：`2026-04-24 00:21:03`
...
- [0001 封面與前置內容](#0001-封面與前置內容)
- [0002 中文摘要](#0002-中文摘要)
- [0003 目錄](#0003-目錄)
- [0004 符號與用詞索引](#0004-符號與用詞索引)
- [0005 一、技術縮寫與平台名詞](#0005-一技術縮寫與平台名詞)
- [0006 二、業務名詞用詞對照（跨正文 / UI / DB / API）](#0006-二業務名詞用詞對照跨正文--ui--db--api)
- [0007 三、用詞規則](#0007-三用詞規則)
- [0008 圖表目錄](#0008-圖表目錄)
- [0009 第一章 開發計畫](#0009-第一章-開發計畫)
- [0010 第一節 發展的動機](#0010-第一節-發展的動機)
- [0011 1.1.1 中小企業 ERP 使用的痛點](#0011-111-中小企業-erp-使用的痛點)
- [0012 1.1.2 傳統 RAG 系統的採用障礙](#0012-112-傳統-rag-系統的採用障礙)
- [0013 1.1.3 Serverless 邊緣運算帶來的機會](#0013-113-serverless-邊緣運算帶來的機會)
- [0014 1.1.4 混合式架構的必要性](#0014-114-混合式架構的必要性)
- [0015 第二節 專題目的](#0015-第二節-專題目的)
- [0016 1.2.1 技術架構面](#0016-121-技術架構面)
- [0017 1.2.2 安全設計面](#0017-122-安全設計面)
- [0018 1.2.3 驗證與營運面](#0018-123-驗證與營運面)
- [0019 1.2.4 核心問題](#0019-124-核心問題)
- [0020 第三節 專題需求](#0020-第三節-專題需求)
- [0021 1.3.1 專題簡介](#0021-131-專題簡介)
- [0022 1.3.2 專題架構](#0022-132-專題架構)
- [0023 1.3.3 實作前確認事項與最小可行閉環](#0023-133-實作前確認事項與最小可行閉環)
- [0024 1.3.4 實作啟動凍結與回填邊界](#0024-134-實作啟動凍結與回填邊界)
- [0025 第四節 預期效益](#0025-第四節-預期效益)
- [0026 第二章 分析與設計](#0026-第二章-分析與設計)
- [0027 第一節 分析](#0027-第一節-分析)
- [0028 2.1.1 使用案例分析](#0028-211-使用案例分析)
- [0029 2.1.2 問答流程分析](#0029-212-問答流程分析)
- [0030 第二節 設計](#0030-第二節-設計)
- [0031 2.2.1 資料庫設計](#0031-221-資料庫設計)
- [0032 2.2.1.1 核心資料表設計](#0032-2211-核心資料表設計)
- [0033 2.2.1.2 引用回放來源建立策略](#0033-2212-引用回放來源建立策略)
- [0034 2.2.1.3 上下文與真相來源設計說明](#0034-2213-上下文與真相來源設計說明)
- [0035 2.2.2 API 與 MCP 介面設計](#0035-222-api-與-mcp-介面設計)
- [0036 2.2.2.1 內部 REST API（前端與管理後台使用）](#0036-2221-內部-rest-api前端與管理後台使用)
- [0037 2.2.2.2 MCP 現階段核心工具](#0037-2222-mcp-現階段核心工具)
- [0038 2.2.2.3 MCP Resources、Dynamic Definitions、Evals](#0038-2223-mcp-resourcesdynamic-definitionsevals)
- [0039 2.2.3 Agent 決策規則](#0039-223-agent-決策規則)
- [0040 2.2.3.1 模型分工](#0040-2231-模型分工)
- [0041 2.2.3.2 檢索參數（現階段預設值）](#0041-2232-檢索參數現階段預設值)
- [0042 2.2.3.3 常數與 feature flag 凍結規則](#0042-2233-常數與-feature-flag-凍結規則)
- [0043 2.2.3.4 分段式決策門檻（現階段預設值）](#0043-2234-分段式決策門檻現階段預設值)
- [0044 2.2.3.5 Self-Correction 觸發條件](#0044-2235-self-correction-觸發條件)
- [0045 2.2.3.6 拒答條件](#0045-2236-拒答條件)
- [0046 2.2.3.7 不納入現階段的 Cloud fallback](#0046-2237-不納入現階段的-cloud-fallback)
- [0047 2.2.4 文件生命週期](#0047-224-文件生命週期)
- [0048 2.2.4.1 上傳與 Ingestion Guardrails](#0048-2241-上傳與-ingestion-guardrails)
- [0049 2.2.5 引用格式規範](#0049-225-引用格式規範)
- [0050 第三節 開發時程](#0050-第三節-開發時程)
- [0051 第四節 其他相關設計或考量](#0051-第四節-其他相關設計或考量)
- [0052 2.4.1 資訊安全設計](#0052-241-資訊安全設計)
- [0053 2.4.1.1 身分驗證與角色控制](#0053-2411-身分驗證與角色控制)
- [0054 2.4.1.2 `allowed_access_levels` 推導與存取矩陣](#0054-2412-allowed_access_levels-推導與存取矩陣)
- [0055 2.4.1.3 MCP 授權](#0055-2413-mcp-授權)
- [0056 2.4.1.4 速率限制與保留期限](#0056-2414-速率限制與保留期限)
- [0057 2.4.1.5 敏感資料治理](#0057-2415-敏感資料治理)
- [0058 2.4.1.6 部署環境與組態真相來源](#0058-2416-部署環境與組態真相來源)
- [0059 2.4.2 與大型 LLM API 方案之比較](#0059-242-與大型-llm-api-方案之比較)
- [0060 2.4.3 平台限制與因應](#0060-243-平台限制與因應)
- [0061 2.4.4 驗證與評估規劃](#0061-244-驗證與評估規劃)
- [0062 2.4.4.1 功能驗證](#0062-2441-功能驗證)
- [0063 2.4.4.2 驗收判定原則](#0063-2442-驗收判定原則)
- [0064 2.4.4.3 資料集分層與凍結規則](#0064-2443-資料集分層與凍結規則)
- [0065 2.4.4.4 效能與品質指標（驗收層級）](#0065-2444-效能與品質指標驗收層級)
- [0066 2.4.4.5 評估方式](#0066-2445-評估方式)
- [0067 2.4.5 部署成本與容量規劃](#0067-245-部署成本與容量規劃)
- [0068 2.4.5.1 成本估算](#0068-2451-成本估算)
- [0069 2.4.5.2 容量與擴展性規劃](#0069-2452-容量與擴展性規劃)
- [0070 第三章 實作成果](#0070-第三章-實作成果)
- [0071 第一節 系統作業環境](#0071-第一節-系統作業環境)
- [0072 3.1.1 硬體環境](#0072-311-硬體環境)
- [0073 3.1.2 軟體環境](#0073-312-軟體環境)
- [0074 3.1.3 開發工具環境](#0074-313-開發工具環境)
- [0075 第二節 功能與介面說明](#0075-第二節-功能與介面說明)
- [0076 3.2.1 流程說明](#0076-321-流程說明)
- [0077 3.2.1.1 知識庫建置流程](#0077-3211-知識庫建置流程)
- [0078 3.2.1.2 問答流程](#0078-3212-問答流程)
- [0079 3.2.2 功能說明](#0079-322-功能說明)
- [0080 3.2.3 操作與介面說明](#0080-323-操作與介面說明)
- [0081 3.2.3.1 登入畫面](#0081-3231-登入畫面)
- [0082 3.2.3.2 主畫面（問答介面）](#0082-3232-主畫面問答介面)
- [0083 3.2.3.3 知識庫管理畫面](#0083-3233-知識庫管理畫面)
- [0084 3.2.3.4 MCP Token 管理畫面](#0084-3234-mcp-token-管理畫面)
- [0085 3.2.3.5 成員管理畫面](#0085-3235-成員管理畫面)
- [0086 3.2.3.6 訪客政策畫面](#0086-3236-訪客政策畫面)
- [0087 3.2.3.7 AI Gateway 用量儀表板](#0087-3237-ai-gateway-用量儀表板)
- [0088 第三節 其他實測或實驗結果](#0088-第三節-其他實測或實驗結果)
- [0089 3.3.1 測試情境設計](#0089-331-測試情境設計)
- [0090 3.3.2 實測結果與正式驗收對照](#0090-332-實測結果與正式驗收對照)
- [0091 3.3.2.1 自動化覆蓋狀態（結構式正確性）](#0091-3321-自動化覆蓋狀態結構式正確性)
- [0092 3.3.2.2 正式驗收統計欄位與判定原則](#0092-3322-正式驗收統計欄位與判定原則)
- [0093 3.3.2.3 驗收延後項的收束契約](#0093-3323-驗收延後項的收束契約)
- [0094 第四章 結論](#0094-第四章-結論)
- [0095 第一節 目標與特色](#0095-第一節-目標與特色)
- [0096 4.1.1 驗收對照項目](#0096-411-驗收對照項目)
- [0097 4.1.2 技術特色與驗證層級](#0097-412-技術特色與驗證層級)
- [0098 第二節 未來展望](#0098-第二節-未來展望)
- [0099 4.2.1 功能擴展方向](#0099-421-功能擴展方向)
- [0100 4.2.2 架構演進方向](#0100-422-架構演進方向)
- [0101 4.2.3 研究限制](#0101-423-研究限制)
- [0102 第五章 專題心得與檢討](#0102-第五章-專題心得與檢討)
- [0103 第一節 組員心得](#0103-第一節-組員心得)
- [0104 第二節 檢討與改進](#0104-第二節-檢討與改進)
- [0105 5.2.1 已完成之規格收斂](#0105-521-已完成之規格收斂)
- [0106 5.2.2 後續驗證事項](#0106-522-後續驗證事項)
- [0107 5.2.3 後續補強重點](#0107-523-後續補強重點)
- [0108 5.2.4 Fallback Synthesizer 取捨說明](#0108-524-fallback-synthesizer-取捨說明)
- [0109 第六章 參考文獻](#0109-第六章-參考文獻)
- [0110 附錄](#0110-附錄)
- [0111 附錄 A：MCP Tools 規格](#0111-附錄-amcp-tools-規格)
- [0112 A.1 `searchKnowledge`](#0112-a1-searchknowledge)
- [0113 A.2 `askKnowledge`](#0113-a2-askknowledge)
- [0114 A.3 `getDocumentChunk`](#0114-a3-getdocumentchunk)
- [0115 A.4 `listCategories`](#0115-a4-listcategories)
- [0116 A.5 授權格式](#0116-a5-授權格式)
- [0117 附錄 B：測試資料集](#0117-附錄-b測試資料集)
- [0118 附錄 C：答辯示範劇本（Demo Script）](#0118-附錄-c答辯示範劇本demo-script)
- [0119 C.1 前情設定](#0119-c1-前情設定)
- [0120 C.2 示範步驟](#0120-c2-示範步驟)
- [0121 C.3 備援情境](#0121-c3-備援情境)
- [0122 C.4 示範後清理](#0122-c4-示範後清理)
- [0123 附錄 D：部署與災難復原](#0123-附錄-d部署與災難復原)
- [0124 D.1 初次部署](#0124-d1-初次部署)
- [0125 D.1.1 Cloudflare 資源建立](#0125-d11-cloudflare-資源建立)
- [0126 D.1.2 Schema Migration](#0126-d12-schema-migration)
- [0127 D.1.3 Runtime Secrets 與憑證設定](#0127-d13-runtime-secrets-與憑證設定)
- [0128 D.1.4 Google OAuth Redirect URI 設定](#0128-d14-google-oauth-redirect-uri-設定)
- [0129 D.1.5 首次部署與煙霧測試](#0129-d15-首次部署與煙霧測試)
- [0130 D.2 日常部署](#0130-d2-日常部署)
- [0131 D.2.1 Pre-deploy 檢查](#0131-d21-pre-deploy-檢查)
- [0132 D.2.2 部署執行](#0132-d22-部署執行)
- [0133 D.2.3 Post-deploy 煙霧測試與 Tag 命名](#0133-d23-post-deploy-煙霧測試與-tag-命名)
- [0134 D.3 災難復原](#0134-d3-災難復原)
- [0135 D.3.1 應用層 Rollback](#0135-d31-應用層-rollback)
- [0136 D.3.2 D1 Schema 退版](#0136-d32-d1-schema-退版)
- [0137 D.3.3 R2 物件還原](#0137-d33-r2-物件還原)
- [0138 D.3.4 Secrets 與 Env Var 還原](#0138-d34-secrets-與-env-var-還原)
- [0139 附錄 E：實模型選型參考](#0139-附錄-e實模型選型參考)
- [0140 E.1 候選模型對照](#0140-e1-候選模型對照)
- [0141 E.2 選型規則](#0141-e2-選型規則)
- [0142 E.3 鎖定流程](#0142-e3-鎖定流程)
- [0143 E.4 不選的替代方案](#0143-e4-不選的替代方案)
...
本專題以中小企業知識庫問答為情境，建置一套基於邊緣原生架構之代理式檢索增強生成系統，作為 ERP 操作指引、制度文件、報表說明與內部 SOP 的統一查詢入口。系統採 Hybrid Managed RAG 架構：檢索由 Cloudflare AI Search 負責，回答生成、拒答、引用組裝與審計治理由應用層 Agent 流程掌控，以兼顧部署可行性、治理可驗證性與後續擴充彈性。

在系統設計上，前端以 Nuxt 提供 Web 問答與管理後台，後端部署於 Cloudflare Workers，整合 D1、R2、KV、AI Search 與 AI Gateway；現階段回答層由應用層 fallback 合成器與結構式判斷器承擔，並保留後續接入 Workers AI 與外部模型路由的擴充空間。本專題已完成可部署、可驗證、可答辯的最小閉環：Google OAuth 配合 Admin/Member/Guest 三級角色 RBAC、文件上傳與版本管理、AI Search 同步、Web 問答、可回放引用，以及 4 個無狀態 MCP Tools。角色部分，Admin 由 `ADMIN_EMAIL_ALLOWLIST` seed，Member 由 Admin 於 UI 升格，Guest 權限由 `system_settings.guest_policy` dial（`same_as_member` / `browse_only` / `no_access`）統一控制，Web 與 MCP 入口均套用同一條閘。正式回答一律以 D1 驗證 `active/indexed/current` 狀態，並以前處理階段預先建立的 `source_chunks` 作為 `citationId` 回放來源。

在問答決策上，本系統採分段式信心判斷：Query Normalization 僅做規則式標準化；第一輪檢索可使用 query rewrite；僅於邊界區間才由 answerability judge 與 Query Reformulation 介入；若證據仍不足則拒答。驗證面以分層資料集、整合測試、引用回放與權限稽核為主，聚焦回答正確性、拒答精準性、引用正確性、MCP Tool 契約穩定性、current-version-only 檢索正確性與遮罩完整性。Web 對話與 MCP 無狀態契約分流；現階段文件 ingestion 已支援 `md`、`txt` 與 `.pdf`、`.docx`、`.xlsx`、`.pptx` 進入 canonical snapshot → replay path，`.doc`、`.xls`、`.ppt` 仍需先轉成現代 Office / 文字格式，scanned / image-only PDF 與媒體檔則不納入可引用同步路徑，並以本版已完成之介面截圖、自動化驗證結果與部署治理設計作為答辯依據。
...
本版以 Markdown 定稿，目錄與頁碼將於正式排版為 PDF 或紙本時自動產生。
...
本報告全文圖表合計 62 張，其中本次補強之重點圖表包括表 2-29 預估月度運營成本、表 2-30 Scale Envelope 與擴展觸發點、表 3-6a 自動化測試覆蓋、表 3-6b TC / UI-state 測試檔對照、表 3-10 驗收延後項收束契約、表 E-1 Workers AI 候選模型對照，共 6 張；表 2-9 為保留編號不列入索引。頁碼以正式排版後為準。
...
表 2-10 conversations 資料表（已完成 conversation lifecycle migration 與 API）.....................................
...
表 2-30 現階段 Scale Envelope 與擴展觸發點 .....................................
...
圖 3-4 MCP Token 管理畫面示意 .....................................

圖 3-5 成員管理畫面示意 .....................................

圖 3-6 訪客政策設定畫面示意 .....................................

圖 3-7 AI Gateway 用量儀表板示意 .....................................
...
表 D-2 現階段必要 Cloudflare 資源清單 .....................................

表 D-3 災難情境與對應復原路徑 .....................................

表 E-1 Workers AI 候選模型對照 .....................................
...
## 0013 1.1.3 Serverless 邊緣運算帶來的機會
...
- 建立以 Cloudflare AI Search 為檢索底層、以角色型模型常數（`models.defaultAnswer` / `models.agentJudge`）為決策與生成層的 Hybrid Managed RAG 架構；現階段核心閉環先以 fallback 合成器取代實際模型呼叫，Vercel AI SDK 與 Workers AI 的實際接入則規劃於後續實模型與營運觀測階段完成。
...
- 以 `@nuxtjs/mcp-toolkit`（`defineMcpTool` + `defineMcpHandler` middleware）實作 MCP Server 的 4 個核心 Tools，並保留單一 `/mcp` 與 `knowledge.*` scope 作為對外互操作契約；現階段先以 Claude remote connector 作為第一個正式 consumer，授權模型則由 legacy Bearer token 過渡至以本地使用者身分為主的 OAuth-compatible remote MCP。[4][15][16][17]
```
...
- 以 better-auth 整合 Google OAuth 與 Passkey，建立單租戶、三級角色的登入與存取控制機制；Admin / Member / Guest 的最終權限真相仍以本地帳號與 `guest_policy` 為準。[13][20]
...
- 現階段 MCP 對外存取採雙軌過渡：正式主路線為使用者授權之 OAuth-compatible remote MCP；legacy Bearer token 則保留於 migration、內部驗證與非使用者型 automation。兩者共用同一組 `knowledge.*` scope、Guest policy 與 HTTPS/TLS 1.3 傳輸要求。[21]
...
綜合上述目標，本專題在實作前聚焦以下三項核心問題，以對應檢索治理、回答品質與對外互操作三類驗證面向。[7][15][16]
...
- 系統管理員：維護知識庫文件、管理版本、查看查詢日誌、管理 legacy MCP token 與 connector 授權治理。
- 外部 AI Client：透過 MCP Tool 使用知識查詢、問答與引用追溯能力；現階段先以 Claude remote connector 為正式整合目標，其他 client 保留為後續延展方向。

現階段的完整範圍與開始實作時的先後順序如下：

表 1-1 現階段實作範圍與先後順序

| 分類     | 首批必做                                                                                                                                                                                               | 後續規劃                                                                                          |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------- |
| 身分驗證 | Google OAuth、Passkey、Admin/Member/Guest 角色、部署環境變數 `ADMIN_EMAIL_ALLOWLIST`                                                                                                                   | Admin 路由與管理介面的細節優化                                                                    |
| 知識管理 | 一次性 signed URL 上傳至 R2、版本管理、`source_chunks` 預建、AI Search 同步、文件狀態管理、`is_current` 發布規則；現階段支援 `md`、`txt` 與 `pdf`、`docx`、`xlsx`、`pptx` canonical snapshot ingestion | legacy Office conversion path、scanned / image-only PDF OCR 評估、音檔 / 影片 transcript pipeline |
| 問答流程 | 規則式 Query Normalization、AI Search 檢索、分段式置信度評估、Self-Correction、拒答、引用顯示、Web 對話歷史                                                                                            | Debug 分數面板、非核心 UI 細節與延遲調校                                                          |
| MCP 介面 | `askKnowledge`、`getDocumentChunk`、OAuth-compatible remote MCP、`knowledge.restricted.read` scope、無狀態呼叫                                                                                         | `searchKnowledge`、`listCategories`、Claude 以外之 connector 相容性與安裝指引補完                 |
| 可觀測性 | 遮罩後 `query_logs`、`source_chunks` / `citation_records`、最小必要決策路徑與設定快照版本                                                                                                              | 管理統計儀表板、延遲趨勢圖、保留期限自動化報表                                                    |

開始實作時，應先完成可部署、可驗證、可答辯的 Web 核心閉環，再補齊現階段尚未納入的後續規劃。

若時程或平台能力與規格衝突，應優先確保目前範圍可部署、可驗證、可答辯；後續規劃不得反客為主。
...
- 應呈現內容：
  1. 前端層：Nuxt 4、Nuxt UI；`@ai-sdk/vue` `useChat` 串流介面保留作後續實模型與互動體驗擴充
  2. 資料與受管理檢索層：Cloudflare Workers、NuxtHub、Drizzle ORM、D1、R2、KV、Cloudflare AI Search
  3. Agentic AI 層：以角色型模型常數（`models.defaultAnswer` / `models.agentJudge`）描述決策路由；現階段以 fallback 合成器承擔答案生成，Vercel AI SDK 與 `workers-ai-provider` 實際接入列為後續版本擴充
  4. MCP 層：`@nuxtjs/mcp-toolkit`（`defineMcpTool` + `defineMcpHandler` middleware）、單一 `/mcp`、OAuth-compatible remote auth + legacy Bearer migration path；Cloudflare 原生 MCP 列為後續選項
  5. 右側以虛線標示後續延伸能力（含 Vercel AI SDK、workers-ai-provider、Cloudflare 原生 MCP），避免與現階段核心架構混寫
  6. 以單一 Cloudflare Edge 邊界框包覆四層，強調邊緣優先與現階段不預設相依於額外跨雲 LLM API

架構說明如下：

- 前端層：使用 Nuxt 4 與 Nuxt UI 建立問答介面、管理後台、設定頁與 connector authorization / consent 狀態頁。現階段使用者以 Google OAuth 或 Passkey 登入，並在同一前端中存取各自權限允許的對話歷史、文件管理頁與 remote MCP 授權流程。[11][12][17]
...
- Agentic AI 層：回答生成與流程控制由應用層掌握。現階段先以角色型抽象定義 `models.defaultAnswer` 與 `models.agentJudge` 兩類模型，實作階段以 fallback 合成器（結合去重後的有效證據片段）承擔答案輸出；實際 Workers AI 模型接入與 Vercel AI SDK 串流則保留至後續實模型與營運觀測階段，接入後仍沿用同一組角色常數與路由規則。第一輪檢索後，系統計算 `retrieval_score`；僅在邊界區間才呼叫 judge，現階段 judge 以「有效證據數量 ≥ 1 且 `retrieval_score >= answerMin`」的結構式判斷回傳 `{ shouldAnswer, reformulatedQuery? }`，後續可無痛替換為真 LLM 判斷。若 judge 回傳 `reformulatedQuery`，則由應用層重送一次檢索並再次評估；單文件、明確、程序型或事實型回答路由到 `models.defaultAnswer`，跨文件整合（目前以「有效證據涵蓋 >= 2 份不同文件」判定）則路由到 `models.agentJudge`。條件式 Cloud fallback 不納入現階段核心驗收。
- MCP 層：以 `@nuxtjs/mcp-toolkit` 的 `defineMcpTool` 建立 4 個核心 MCP tools，對應單一 `/mcp` JSON-RPC endpoint；透過統一 middleware 驗證 Bearer token 與 scope（現階段為 Nitro 原生 event handler，後續即使完成 MCP 執行框架收斂，tool 名稱與 I/O 契約亦保持不變）。現階段的 MCP 採無狀態呼叫，不建立 `MCP-Session-Id` 相依性；Web 對話與 MCP 工具契約因此分別對應「D1 持久化對話輔助」與「單次請求契約」。若後續版本導入多輪上下文，runtime state 仍應保存於 KV，而非與 Web 對話混寫；若再升級至 Cloudflare 原生 MCP，仍須維持同一組 scope 與治理契約。[4][15][16]

雖然 Cloudflare AI Search 已提供 public endpoint 與原生 MCP 能力，[7][26][28] 本專題現階段仍選擇在應用層自建 MCP。主因是正式回答前必須統一經過 D1 `active/indexed/current` 驗證、`restricted` scope 檢查、`source_chunks` 可回放引用對應與遮罩後查詢日誌；若直接暴露供應商原生 MCP 端點，將難以保證 Web 與 MCP 共用同一套發布真相與審計規則。

Cloudflare AI Search 每個 instance 最多支援 5 個 custom metadata 欄位。[7][24] 本系統現階段固定保留 4 個核心欄位：`document_version_id`、`category`、`status`、`access_level`；`version_state` 僅於需要輔助管理後台觀測或同步檢查時作為第 5 個選用欄位，不作正式回答的硬性判斷依據。其中 `document_id` 與 `version_no` 不再額外占用 custom metadata，而是由 `folder = /kb/{category}/{document_id}/v{version_no}/` 路徑策略與 D1 回推。此設計是為了符合 AI Search custom metadata 上限，同時保留分類篩選、版本追蹤與資料治理判斷。`documents.tags` 僅保留於 D1 供管理後台管理與後續延伸，不同步至 AI Search，也不作為現階段 MCP 對外檢索契約參數。
```

---

## 0023 1.3.3 實作前確認事項與最小可行閉環
...
| 引用回放   | 確認驗收資料集的候選片段可穩定對應至既有 `source_chunks`                                                 | 用於驗收與答辯的 current 文件皆能通過 smoke retrieval 與 `citationId` 回放                           | 若 rich format canonical snapshot 不穩定，先回退至 `md`、`txt` 或人工校閱文字版；`.doc`、`.xls`、`.ppt` 與 scanned / image-only PDF 不作核心 pass/fail 依據 |
...
| 範圍收斂   | 確認現階段先完成可展示的最小閉環，而非一次完成所有優化項                                                 | 至少完成「文件發布 → Web 問答 → 引用回放 → current-version-only 驗證 → 權限隔離 → 查詢日誌」六步閉環 | 延後 debug 視覺化、進階調校與非核心 UI 細節，不得為了展示而先做不納入目前範圍之能力                                                                         |
...
上述閉環中的「引用回放」屬核心能力，而非可有可無的 MCP 外層功能。實作順序可先以內部驗證流程或測試 harness 確認 `citationId` 回放，再於核心檢索穩定後接上 `getDocumentChunk`；但現階段正式驗收與答辯稿仍須補齊 4 個無狀態 MCP Tools。

若時程受壓，現階段的刪減順序應為：先延後 debug 分數面板與管理摘要視覺化，再延後 legacy Office / 媒體 / OCR 類擴充，最後才縮減 MCP 以外的輔助功能；不得先刪 current-version-only、引用回放、權限隔離與遮罩記錄等核心治理能力。
```

---

## 0024 1.3.4 實作啟動凍結與回填邊界
...
| 通道邊界 | Web 對話持久化與 MCP 無狀態契約分流                                                                                 | 現階段不接受 `MCP-Session-Id`，亦不啟用 Passkey 與 Cloud fallback                                              |
...
因此，只要首批必做與上述 invariant 已凍結，即可放行開始實作；後續規劃與回填項可隨核心閉環完成後逐步補齊。
```
...
本系統採固定主線的 Agentic RAG 問答流程，明確區分「AI Search 負責檢索」與「應用層負責回答生成」。現階段將三層查詢處理責任凍結為：`Query Normalization` 僅做規則式標準化、不呼叫模型；第一輪檢索可使用 AI Search 的 `rewrite_query`；只有在證據不足且值得重試時，才由 `models.agentJudge` 執行一次 Query Reformulation。此設計可避免三層改寫互相覆蓋，並使延遲與責任邊界保持可驗證。[7]
...
5. **第一階段置信度評估**：現階段以通過遠端 metadata 與 D1 current 驗證之候選片段，計算 `mean_top3_score` 作為 `retrieval_score`；完整 `top1_score`、`evidence_coverage`、`cross_document_gate_failed` 加權公式列為後續實模型與營運觀測階段擴充。
...
| 後續實模型與營運觀測階段擴充 | `0.50 * top1_score + 0.30 * mean_top3_score + 0.20 * evidence_coverage`，並套用 `cross_document_gate_failed` 硬門檻 | `evidence_coverage` = `0.60 * evidence_sufficiency + 0.25 * document_diversity_score + 0.15 * verification_integrity` |

`confidence_score` 在 現階段不獨立計算：進入邊界區間時，由 judge 回傳的結構化 `{ shouldAnswer, reformulatedQuery? }` 直接決定走 `direct` 或 `self_corrected`，若都不成立則 `refused`；`confidence_score = 0.80 * retrieval_score + 0.20 * answerability_judge` 的合成版本列為後續實模型與營運觀測階段擴充，屆時搭配 `query_logs.judge_triggered` / `answerability_judge_score` / `confidence_score` 欄位一起導入。
...
if retrieval_score >= thresholds.directAnswerMin:
 ...
 retrieval_score < thresholds.judgeMin:
  decision = 'refused'
else:
...
實作端的 `models.defaultAnswer` / `models.agentJudge` 常數對應的 fallback 合成器與結構式判斷器，可於後續實模型與營運觀測階段替換為真 LLM 呼叫，不影響上述判斷流程。
...
2. `md` / `txt` 直接正規化；`pdf` / `docx` / `xlsx` / `pptx` 需先轉為可檢查之 canonical text snapshot，確認段落、標題、工作表 / 投影片結構與主要表格文字未嚴重缺失後，才可進入後續流程；其中 PDF 若抽不出可選取文字（例如 scanned / image-only source）即視為 non-replayable。
...
| created_by_user_id | string (FK → user.id)                   | 建立者；三級角色擴充後新增，用於在 MCP 入口以 token 創建者 role × `guest_policy` 做授權判定。此欄位先以可回填方式導入，後續再收斂為必填。 |
...
## 0036 2.2.2.1 內部 REST API（前端與管理後台使用）
...
後續規劃（尚未納入本版交付，將依治理深化、管理介面深化與營運觀測三條線分階段補齊）：
...
- Cloudflare AI Search 已提供同步 REST API；現階段將「文件重同步」凍結為應用層工作流程：先標記目標版本、呼叫部署當下官方可用的同步能力，並由 `document_versions.sync_status` 與 `metadata_json` 回寫結果，不把供應商特定 API 直接綁死在報告規格中。[26]
...
## 0038 2.2.2.3 MCP Resources、Dynamic Definitions、Evals
...
模型可用性與命名以 Workers AI 官方模型頁與部署當下可用清單為準。[6][27] 因供應商模型清單與 alias 可能變動，現階段先固定「角色」與「路由條件」，再於 Preview 驗證通過後鎖定實際模型名稱。
...
## 0042 2.2.3.3 常數與 feature flag 凍結規則
...
## 0043 2.2.3.4 分段式決策門檻（現階段預設值）

```markdown
#### 2.2.3.4 分段式決策門檻（現階段預設值）

表 2-21 分段式決策門檻（現行做法：以 `retrieval_score` 單一指標 + judge 結構式回傳）
...
後續實模型與營運觀測階段補齊 `confidence_score` 後，將額外加上 `confidence_score < thresholds.answerMin → refuse` 這一層門檻，並把「judge 回傳 `shouldAnswer = false` 但附帶 `reformulatedQuery` 的路徑」明確命名為 `self_corrected`。
```

---

## 0044 2.2.3.5 Self-Correction 觸發條件
...
現階段不依賴「Query Normalization 辨識出明確遺漏實體」之啟發式判斷；是否值得 retry 完全由 judge 回傳的 `reformulatedQuery` 是否存在決定。Query Normalization / 實體辨識列為後續治理深化階段擴充，擴充後可補充一條「即使 judge 未回傳 `reformulatedQuery`，若偵測到遺漏實體亦可重寫」的 fallback 路徑。
```
...
## 0046 2.2.3.7 不納入現階段的 Cloud fallback

```markdown
#### 2.2.3.7 不納入現階段的 Cloud fallback

現階段不啟用 Cloud fallback。若後續版本擴充，必須同時滿足以下前提：
...
表 2-22 文件生命週期狀態轉移規則（現階段：以 `document_versions.index_status + sync_status` 承擔同步任務狀態機）
...
- AI Search 同步觸發若遭遇冷卻期（`sync_in_cooldown`），應視為暫時性狀況而非失敗：`sync_status` 維持或回退至 `pending`、不寫入 `error_message`、不觸發告警；由排程或後續上傳事件自然重試。
...
## 0048 2.2.4.1 上傳與 Ingestion Guardrails
...
- rich format 文件（例如 `pdf`、`docx`、`xlsx`、`pptx`）若超出 Cloudflare AI Search 當前公開限制，應在上傳前提示管理員改傳 Markdown/TXT，或先經應用層轉換為 canonical text snapshot 後再同步；答辯核心資料集不得把供應商自動轉檔當成唯一相依路徑。以 2026-04 查核時，官方公開 rich format 上限已提升至 4 MB。[26]
...
- 里程碑：
  ...
  - M2：Google OAuth、`ADMIN_EMAIL_ALLOWLIST`（W3）
  - M3：文件管理、版本管理、R2 上傳、AI Search 同步（W4–W5）
  - M4：問答主流程、引用組裝、對話歷史（W6–W8）
  - M5：置信度評估、Query Reformulation、Self-Correction、拒答（W9–W10）
  - M6：MCP Tools、Middleware、Bearer token 管理（W11）
  - M7：查詢日誌、rate limit、保留期限與錯誤處理（W12–W13）
  - M8：測試、報告回填、答辯準備（W14–W15）
...
| M5   | W9-10  | 置信度評估、Self-Correction、拒答           | 智慧問答能力             |
| M6   | W11    | MCP Tools、Bearer token                     | 可互操作的 MCP Server    |
| M7   | W12-13 | 查詢日誌、rate limit、保留期限、錯誤處理    | 可觀測與可治理版本       |
| M8   | W14-15 | 測試驗證、圖表回填、報告與答辯資料          | 完整專題交付物           |

若時程受壓，應優先完成 1.3.3 所定義之最小可行閉環，再處理 MCP 契約擴充、legacy Office / 媒體 / OCR 類延伸與畫面優化；不得為了趕展示而先跳過 current-version-only、引用回放或權限治理。
````
...
## 0054 2.4.1.2 `allowed_access_levels` 推導與存取矩陣
...
| Web Guest（`guest_policy = no_access`）                                | `[]`                         | 登入後僅見「帳號待審核」提示頁；Web 與 MCP 全部入口拒絕                                                |
...
- 現階段不啟用 Cloud fallback；若後續版本啟用外部模型，`restricted` 文件仍不得外送。
...
- 另以人工檢查比對 `source_chunks`、`citation_records`、`document_versions.is_current`、`query_logs.redaction_applied`、`messages.content_redacted` 與 blocked rows 的 `messages.content_text IS NULL`，驗證引用可回放性與記錄治理。
...
## 0067 2.4.5 部署成本與容量規劃

```markdown
### 2.4.5 部署成本與容量規劃

本節補充作為回應「§1.4 預期效益」所宣稱之「降低基礎設施管理複雜度」與「以邊緣原生架構降低維運負擔」的情境化規劃依據。成本與容量皆以 2026-04 時點之 Cloudflare 公開計費與限額為基準，用途是提供部署規劃與答辯討論參考，不應被解讀為本版已完成之正式營運統計；實際運行費用仍須於 Preview / Staging 實測後再回填。
```
...
現階段預期部署規模為單租戶、中小企業內部使用（估 5–50 位啟用帳號、每日 50–500 次問答、知識庫 50–500 份 md / txt 文件）。在此規模下，以 Cloudflare 免費方案與 Workers Paid（US$5/月）方案做雙層試算如下。

表 2-29 現階段情境化月度運營成本估算
...
| Workers AI              | Neurons（依模型與 token 計費） | 500 次 / 日 × 30 日 × 平均 500 Neurons = 7.5M / 月 | Paid：10k Neurons / 日含（300k / 月）；超額約 $0.011 / 1k Neurons | $79.2（超額 7.2M） | 實際費用視所選模型而定，現階段 fallback synthesizer 不計費；接入實模型後成本大頭在此 |
| AI Search               | Queries + Indexed documents    | 500 次 / 日 × 30 日 = 15k / 月；文件 < 500 份      | 具體計費於 2026-04 仍在調整，預計 beta 期間不另計費；文件索引免費 | 0（beta）          | 依 [26] 最新 release note 為準；若 GA 後計費，再回填                                 |
...
| **合計（Fallback 期）** | —                              | —                                                  | —                                                                 | **$5.00**          | 現階段以 fallback synthesizer 運行之月費                                             |
| **合計（實模型期）**    | —                              | —                                                  | —                                                                 | **≈ $84.20**       | 後續接入 Workers AI 實模型後之估算月費                                               |

超額試算：若單月請求爆增至 500k、Workers AI 使用至 75M Neurons（10 倍規模），則月費可能升至數百美元等級。此處僅用來說明「成本主要會集中在實模型推理層」，不應被解讀為本版已完成之正式成本實測依據；若後續接入外部雲端模型，也需以當時官方單價重新估算。

備註：

1. 上述 Workers AI Neurons 估算以「每次問答 500 Neurons」為粗估，實際隨模型與回答長度浮動，需於後續實模型與營運觀測階段以 AI Gateway 聚合數據回填。
2. 成本估算不含網域、SSL（Cloudflare 提供）、Email（Better Auth 以 Google OAuth 轉發，無額外費用）、監控告警（依賴 Cloudflare 原生 dashboard）。
3. 若未來開啟 Cloud fallback（外部 LLM API），成本結構將改以外部 API token 計費為主，需另行估算並以 feature flag 治理。
```

---

## 0069 2.4.5.2 容量與擴展性規劃
...
| 日問答請求                | 500 次 / 日                                    | Workers AI 免費 10k Neurons / 日；以平均 500 Neurons 估算支援 ≈ 20 次；Paid 支援 500 次 / 日以上                  | 切換付費方案並開啟 AI Gateway cache；若持續爆量，考慮 Cloud fallback 分流 |
...
本節與 §2.4.3 表 2-27（平台限制與因應）互補：表 2-27 描述限制本質與因應原則，本節以量化數字描述現階段在此限制下的可用範圍與擴展門檻。
...
本章彙整本系統目前已完成的作業環境、主要功能介面與驗證結果，重點放在可重現的部署組態、核心頁面狀態與自動化測試證據。凡與長期營運觀測或實模型品質統計相關者，則於本章第三節與第四章清楚說明其驗證邊界，不以未完成欄位取代既有成果。
```
...
本節以目前工作區的 `package.json`、lockfile 與已接入之雲端服務狀態為依據，整理本系統實作所使用的主要軟體環境。受管理服務以官方公開狀態標示，專案內套件則以本版工作區實際版本為準。
...
本節 7 張實機截圖（圖 3-1 ~ 3-7）以 desktop 環境（1920×1080 或等價 viewport）為主，聚焦結構、角色、狀態、lifecycle 等語義驗收；對應 §3.2.2 表 3-4「響應式與無障礙」之 mobile / tablet / desktop 三 breakpoint 實機證據，則由 **EV-06（§3.3.2 表 3-9）** 獨立承擔，驗證文件與截圖清單詳見 `docs/verify/RESPONSIVE_A11Y_VERIFICATION.md`。此分工之理由有三：

1. **職責切分**：本節截圖重點在「每個畫面該有什麼欄位 / 狀態 / lifecycle 表現」，不重疊 EV-06 的跨 viewport 版面崩潰檢查。
2. **避免截圖膨脹**：若每個 UI 都拍三 viewport，圖表目錄將達上百張，閱讀性劣化；集中到 EV-06 以 batch 方式驗證更有效率。
3. **正式驗收時一併補齊**：mobile / tablet viewport 之實機截圖與 `@nuxt/a11y` dev report 將於正式驗收階段統一補齊（詳見 §3.3.2.3 表 3-10 收束契約），不在本節逐張重拍。
...
本節 7 張實機截圖（圖 3-1 ~ 3-7）皆於 2026-04-21 於 local dev 環境拍攝，後續修訂僅調整報告文字與驗收說明，未改動畫面內容。圖 3-2（含回答與引用卡片版本）與圖 3-7（含實際用量資料版本）之補拍時機，另見 §3.3.2.3 表 3-10。
```
...
圖 3-1 登入畫面實機畫面（2026-04-21，local dev 環境）

實機狀態：loaded；顯示「知識問答系統」主標、「使用公司帳號登入系統」副標、Google 登入按鈕，以及「首次登入後，系統會根據帳號設定自動指派角色」提示（對應 §2.4.1.1 OAuth callback 自動建立 Guest 的說明）。
...
## 0082 3.2.3.2 主畫面（問答介面）

```markdown
#### 3.2.3.2 主畫面（問答介面）

圖 3-2 問答主畫面實機畫面（2026-04-21，local dev 環境）
...
## 0083 3.2.3.3 知識庫管理畫面

```markdown
#### 3.2.3.3 知識庫管理畫面

圖 3-3 知識庫管理畫面實機畫面（2026-04-21，local dev 環境）
...
**MCP 不涉及 agent-initiated approval**：現階段 MCP 4 個 tool 全為 read-only（`searchKnowledge` / `askKnowledge` / `getDocumentChunk` / `listCategories`），不執行任何破壞性操作；因此表 3-5 的確認策略僅適用於 Web Admin 管理介面，不延伸至 MCP 契約。
```

---

## 0084 3.2.3.4 MCP Token 管理畫面

```markdown
#### 3.2.3.4 MCP Token 管理畫面

圖 3-4 MCP Token 管理畫面實機畫面（2026-04-21，local dev 環境）
...
圖 3-5 成員管理畫面實機畫面（2026-04-21，local dev 環境）
...
圖 3-6 訪客政策設定畫面實機畫面（2026-04-21，local dev 環境）

實機狀態：loaded；顯示三選一 radio dial，目前選 `same_as_member`（同成員（預設））並附「目前」標記；另二選項 `browse_only`（僅可瀏覽）、`no_access`（完全不開放）各附對 Web Chat 與 MCP 的具體影響說明。頁首敘述明確標示「修改後新政策會透過 KV version stamp 於所有 Worker 實例下次請求時立即生效」，對應 §2.4.1.1 與表 2-24 MCP 入口閘的運作原理。
...
- 操作要求：
  ...
  - 若切換為 `no_access`，前端需額外警示「所有目前 Guest 將立即只能看到『帳號待審核』提示頁」
```

---

## 0087 3.2.3.7 AI Gateway 用量儀表板

```markdown
#### 3.2.3.7 AI Gateway 用量儀表板

圖 3-7 AI Gateway 用量儀表板實機畫面（2026-04-21，local dev 環境）

實機狀態：**error (graceful)**；本機開發環境未配置 `CLOUDFLARE_API_TOKEN_ANALYTICS`，因此 `/api/admin/usage` 回非 2xx，前端顯示「無法載入用量資料」placeholder、原因說明與「重新載入」按鈕，而非整頁崩潰。此畫面用於驗證管理介面在外部分析 API 暫時不可用時，仍能維持可理解、可操作的降級呈現，對應表 2-27「平台限制與因應」的可降級原則，並與 UX Completeness 規則要求之 `empty / loading / error / unauthorized` 四態覆蓋一致。
...
## 0090 3.3.2 實測結果與正式驗收對照

```markdown
### 3.3.2 實測結果與正式驗收對照

本節分兩層呈現：第一層以目前已完成的自動化覆蓋結果說明系統在流程、權限、引用與契約層面的結構式正確性；第二層則將正式驗收所需的統計欄位、逐案判定原則與補充證據項目固定下來，確保後續於相同資料集與門檻下累積的數據可與本版結果對照。附錄 B 的 `gold facts`、必要引用與不可犯錯欄位，是逐案判定的主來源，不得只憑回答是否流暢或看似合理決定通過與否。
```

---

## 0091 3.3.2.1 自動化覆蓋狀態（結構式正確性）

```markdown
#### 3.3.2.1 自動化覆蓋狀態（結構式正確性）

本表彙整 2026-04-21 以 `pnpm verify:acceptance` 與 `pnpm test:integration` 執行之測試檔與通過數量，用以佐證 §2.1.2 問答流程、§2.2 資料模型與 §2.4.1 授權治理在結構式判斷器與 fallback 合成器下行為正確。實模型相關延遲與品質指標不在此列。
...
| TC-13                 | `acceptance-tc-13.test.ts`       | 2               | `restricted` 引用越權 + `query_logs` 稽核（tc-acceptance-followups 補齊） |
| TC-14                 | `acceptance-tc-14.test.ts`       | 1               | Admin 於 Web 問答查詢 `restricted`                                        |
| TC-15                 | `acceptance-tc-15.test.ts`       | 2               | 高風險輸入（含信用卡號 block，tc-acceptance-followups 補齊）              |
...
上述自動化測試已完成本版核心功能的結構式驗證；涉及長期營運期數據、實模型延遲分布與大樣本品質統計者，則依下列正式驗收欄位持續累積。
```

---

## 0092 3.3.2.2 正式驗收統計欄位與判定原則

```markdown
#### 3.3.2.2 正式驗收統計欄位與判定原則

除情境彙總表外，正式驗收亦需同時保留按 `TC-xx` 填寫的逐案結果表，以及處理部署、身分與版本交易等非問答證據的 `EV-xx` 補充證據表，確保第三章資料可逐項回對第四章驗收命題。下列表格的功能在於固定驗收格式與判定依據，而非以空白數據取代既有成果。
...
| 證據編號 | 對應 Acceptance ID | 驗收重點                                         | 建議證據形式                                                                                                            | 通過條件                                                                                                                      | 既有 runbook / 驗證文件                                                                                                                  |
| -------- | ------------------ | ------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
...
| EV-02    | A08                | OAuth + 三級 RBAC + `guest_policy` dial 行為     | 登入截圖（圖 3-1、圖 3-5、圖 3-6）、Session 權限比對紀錄、allowlist / dial 異動前後操作結果、`member_role_changes` 稽核 | 管理員身分可隨 allowlist 異動即時重算，不殘留舊權限；dial 切換可即時影響 Web 與 MCP 入口                                      | `docs/verify/OAUTH_SETUP.md`、相關權限驗證紀錄、圖 3-5 / 3-6                                                                             |
...
## 0093 3.3.2.3 驗收延後項的收束契約

```markdown
#### 3.3.2.3 驗收延後項的收束契約

本節用以補足「已完成自動化覆蓋，但仍需正式驗收統計與補充證據」之間的收束關係。換言之，本版主要結論建立於現有測試與介面證據之上，而長期營運與實模型相關驗證，則應透過本節明確說明其完成時機、資料集與通過門檻，避免驗收邊界失焦。

表 3-10 驗收延後項收束契約

| 延後項（對應 Acceptance ID）                      | 結案環境                              | 執行者   | 資料集 / 來源                           | 通過門檻                                                                                                                                                 | 預計觸發時機                                                      |
| ------------------------------------------------- | ------------------------------------- | -------- | --------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| 表 3-7 實測情境彙總統計（A02 / A05 / A06 / A07）  | Preview → Staging（正式驗收前）       | 作者本人 | 正式驗收資料集 30–50 筆                 | 覆蓋 §2.4.4.4 硬性驗收三項（Current-Version / Restricted / Redaction）均 100%，品質驗收四項（Citation / Answer / Refusal / MCP Success）達表 2-28 目標值 | 後續接入 Vercel AI SDK + Workers AI 實模型後跑一輪                |
| 表 3-8 TC 逐案測試結果（A02 / A05 / A06 / A07）   | 同上                                  | 作者本人 | 同上                                    | 每一筆案例皆符合 `gold facts` / 必要引用 / 不可犯錯三項判定原則，不可犯錯命中即整案 fail                                                                 | 與表 3-7 同時跑，逐案輸出 `config_snapshot_version` 後凍結        |
| 圖 3-2 問答主畫面（A02 / A03；含回答 + 引用卡片） | Staging（含 AI Search 真實索引）      | 作者本人 | 至少一份 `rag-test-active` current 文件 | 畫面顯示使用者提問 → 串流回答 → 至少 1 張可點開之引用卡片（顯示文件名、版本、`citationId`、摘錄）                                                        | AI Search 索引與實模型接入完成後補拍                              |
| 圖 3-7 AI Gateway 用量儀表板（A08；loaded）       | Staging / Production                  | 作者本人 | 真實 `CLOUDFLARE_API_TOKEN_ANALYTICS`   | 頂部指標卡（tokens / requests / cache hit / Neurons）均顯示數字，近 24h 折線圖有資料點                                                                   | `CLOUDFLARE_API_TOKEN_ANALYTICS` 設定完成且累積 >= 24h 流量後補拍 |
| 圖 1-1 系統功能圖、圖 1-2 系統架構圖（A01）       | 離線製圖工具（draw.io / Excalidraw）  | 作者本人 | §1.3.2 / §1.3.3 敘述                    | 圖面與正文敘述一致、核心四層邊界清楚、延伸能力以虛線區分                                                                                                 | 定稿排版階段                                                      |
| 圖 2-1 ~ 2-4 問答流程圖（A02 / A05）              | 同上                                  | 作者本人 | §2.1.2 敘述                             | 流程含「Query Normalization → 第一輪檢索 → 分段決策 → 第二輪重試 → 拒答／回答」五條主路徑                                                                | 定稿排版階段                                                      |
| §5.1 組員心得（全域）                             | 紙本撰寫                              | 作者本人 | 實作過程筆記                            | 涵蓋模組責任、技術取捨、SDD / TDD / LLM pair programming 學習點，至少 500 字                                                                             | 正式驗收完成後、交付前                                            |
| 封面日期、目錄頁碼（全域）                        | Word / Pandoc 排版                    | 作者本人 | 本文件                                  | 日期填入實際交付日、目錄可對應章節與頁碼、圖表目錄張數與內容對齊                                                                                         | 定稿排版階段                                                      |
| 套件小版本號、實際模型名稱（A01 / A02）           | lockfile / Cloudflare Workers AI 清單 | 作者本人 | `pnpm-lock.yaml` / Workers AI 官方頁面  | 與首次通過核心閉環驗證之 lockfile 一致；模型名稱同步寫入部署設定與 `query_logs.config_snapshot_version`                                                  | 第一次可重現通過核心閉環驗證時                                    |

表 3-10 與既有表 1-4（佔位內容與回填時機）互補：表 1-4 宣告「不阻擋開始實作」，表 3-10 宣告「阻擋最終交付的收束條件」。兩者合起來形成完整的延後項治理：開工前只凍結 invariant，交付前必須通過本節的收束門檻。
...
「目前狀態」欄採三級分級：**結構性保障**（由 schema / migration 強制、無需 runtime 驗證）、**自動化覆蓋**（整合測試已驗證結構式正確性；長期營運與實模型延遲統計另於正式驗收補充）、**待驗收**（需部署環境實測或長期觀測才能結案）。

| Acceptance ID | 驗收目標                                                                                               | 對應章節            | 主要對應案例                      | 驗收證據                                                                                                          | 目前狀態                                                                                                              |
| ------------- | ------------------------------------------------------------------------------------------------------ | ------------------- | --------------------------------- | ----------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| A01           | 邊緣原生架構可部署                                                                                     | 1.2.1、1.3.2        | EV-01                             | 部署紀錄、系統架構圖、Smoke Test                                                                                  | 待正式驗收（系統已多次完成部署與 smoke 驗證；交付前仍需補齊最終部署紀錄與架構圖）                                     |
| A02           | 完成 AI Search 與自建 Agent 流程整合                                                                   | 1.2.1、2.1.2        | TC-01、TC-04、TC-06、EV-01        | 查詢日誌、引用紀錄、模型路由紀錄                                                                                  | 自動化覆蓋（TC-01/04/06 全綠；實模型延遲與品質統計待正式驗收）                                                        |
...
| A05           | Self-Correction 可改善模糊查詢                                                                         | 2.1.2、2.4.4        | TC-04                             | judge `reformulatedQuery` 重試前後比較報告                                                                        | 自動化覆蓋（TC-04 通過；實模型 reformulate 品質待正式驗收）                                                           |
| A06           | 拒答機制可正確阻擋越界或高風險查詢                                                                     | 1.2.2、2.4.1        | TC-07、TC-08、TC-09、TC-15        | 測試集與拒答紀錄                                                                                                  | 自動化覆蓋（TC-07/08/09/15 全綠，含信用卡號 block 路徑）                                                              |
| A07           | MCP 4 個 Tools 可被外部 Client 正常使用                                                                | 2.2.2、3.2.2        | TC-12、TC-16、TC-17、TC-19、TC-20 | Claude Desktop / Cursor / MCP Inspector 測試結果                                                                  | 自動化覆蓋（MCP contracts 15 檔 51 tests 全綠；外部 Client 實連待正式驗收）                                           |
| A08           | Google OAuth + 三級角色 RBAC + `guest_policy` dial 正常運作（`ADMIN_EMAIL_ALLOWLIST` 僅作 Admin seed） | 2.4.1、3.2.3        | EV-02、EV-06、TC-UI-01            | 登入截圖（圖 3-1 / 3-5 / 3-6）、升降／dial 切換前後的權限比對、`member_role_changes` 稽核紀錄、響應式與 a11y 證據 | 自動化覆蓋（TC-UI-01 7 assertions 含升降流程全綠；實機截圖已備；OAuth 實連待正式驗收）                                |
...
| A13           | rate limit 與保留期限規則可被驗證                                                                      | 2.4.1               | EV-04                             | `429` 測試紀錄、`citation_records.expires_at` 清理作業摘要                                                        | 待正式驗收（`docs/verify/RETENTION_CLEANUP_VERIFICATION.md` 已備；交付前仍需完成 backdated record 清理流程）          |
...
- **延伸驗證邊界**：長期營運期數據、實模型品質與延遲分布，需於後續實際運轉與正式驗收階段持續觀察。

各特色分級如下（詳細驗證證據見 §4.1.1 表 4-1 對應 Acceptance ID）。
...
3. **拒答作為產品級信任門檻**（拒答軸）｜*已達結構式驗證*：企業知識庫若在不確定時亂答，使用者信任成本比「不答」更高。本系統以規則式 Query Normalization + 分段式置信度 + 重試後仍低分則拒答的結構式流程，確保回答與拒答皆可回放、可稽核；拒答精準率列為硬性驗收指標（§2.4.4.4 表 2-28），並於使用者介面提供下一步引導（如改寫關鍵字、查看相關文件），而非僅回傳「無法回答」；TC-07/08/09/15 全綠佐證。
...
7. **治理前置**｜*已達結構式驗證；實模型接入後需再次複核*：`restricted` scope、版本發布規則、rate limit、保留期限與記錄遮罩在規格階段即明確定義；TC-13/14/15/17 全綠佐證 scope 隔離與 existence-hiding。實模型接入後需確認 prompt 工程不反向破壞遮罩承諾。
8. **分階段落地**（邊緣原生軸）｜*已達結構式驗證*：先完成現階段核心範圍，再把 Passkey、MCP Session 與 Cloud fallback 留作後續版本；近期實作已將三級 RBAC、AI Gateway 用量前置與響應式 / a11y 基線納入核心範圍，示範分階段落地之工程可行性。
...
5. 規劃 LINE Login 與細粒度文件 ACL，補足現階段尚未納入之能力。
6. **使用者操作示範代理（UI Demonstration Agent）**：針對 §1.1.1 識別之「學習成本高」痛點，後續版本可擴充使用者介面導覽代理功能。當新進人員以自然語言詢問「怎麼上傳文件」「怎麼建立新版本」等操作問題時，系統除了以現有問答流程提供步驟文字外，亦可視情境切換為「示範模式」，由 Agent 直接在 UI 上以可見游標移動、逐步解說、等待使用者確認後才繼續下一步，並允許使用者隨時中斷接手操作。此模式除降低文件閱讀負擔外，更符合中小企業新進員工現場即學即用的需求。屬後續版本探索項目，不在現階段核心驗收範圍。
```
...
1. 本研究以已完成的核心閉環、自動化驗證與短期實機操作證據為主，尚未累積長期營運期數據與大樣本使用者行為分析。
2. AI Search 與邊緣模型服務仍持續演進，相關 alias、計費與能力上限需於實際部署時再次核對官方文件。
3. 目前系統採單租戶與兩級敏感等級設計，足以支撐本專題情境，但仍不足以涵蓋完整企業級細粒度 ACL 模型。
4. Passkey、MCP Session 與 Cloud fallback 已明確列入架構演進方向，但不納入本版成果結論，以維持驗收邊界清楚。
...
本章整理本專題在規格收斂、系統實作與驗證過程中的主要收穫與仍待改進之處，重點不在重述功能清單，而在說明技術選擇背後的原因，以及這些選擇對系統品質、可維護性與答辯呈現造成的影響。
```
...
第二個明顯的體會，是邊緣原生架構雖然降低了伺服器維運負擔，卻同時把系統設計的要求推向更嚴格的工程紀律。Cloudflare Workers、D1、R2、KV 與 AI Search 提供了很完整的服務鏈，但也帶來 CPU 時間、最終一致性、metadata 上限與部署組態管理等限制。這些限制迫使我不能用傳統「先做大再慢慢收」的方式開發，而必須先界定最小可行閉環，再逐步補齊驗證與營運能力。從這個角度看，專題真正的難點不是功能數量，而是如何在受限的執行環境下，仍維持資料一致性、介面可理解性與契約穩定性。

第三個收穫來自開發方法。Spec-Driven Development、測試先行與 AI 輔助開發在本專題中不是彼此替代，而是互相制衡。規格先定義邊界，測試負責驗證行為，AI 工具則協助加速查詢、重構與文件整理；但只要規格不清楚、驗收條件不明確，再強的 AI 也只會放大模糊。實作過程中，我最深刻的感受是：AI 輔助可以提高開發速度，卻無法取代工程判斷；真正讓系統穩定成形的，仍然是明確的資料模型、可重現的驗證流程，以及願意對尚未完成的部分誠實收斂。這也讓我對未來延伸到實模型接入、長期營運觀測與更細緻權限模型時，該如何維持專案品質，有了更具體的判斷基準。
```
...
目前已先將現階段的核心責任邊界定清，包括 AI Search 僅負責檢索、回答生成由自建 Agent 流程掌控、`getDocumentChunk` 以 `source_chunks.id` 作為可回放 `citationId`、Web 對話與 MCP 契約分流，以及 `restricted` scope、rate limit、保留期限與記錄遮罩等治理規則的邊界。

近期修訂進一步補強以下已實作成果，作為本版報告的核心支撐：
...
2. **AI Gateway 用量觀測整合完成**：所有 Workers AI 呼叫前置至 AI Gateway，於 `/admin/usage` 呈現 tokens、requests、cache hit rate 與 Neurons 剩餘額度；現階段此頁面作為觀測與容量評估依據，不承擔自動降載。
3. **認證與 Token 資料一致性修正完成**：Better Auth 時間欄位語意已統一，MCP token 建立者欄位亦收斂為必填，降低權限追溯與稽核上的歧義。
...
上述項目均已進入生產環境並透過單元 / 整合 acceptance 測試（`test/integration/acceptance-tc-*.test.ts`）持續驗證；正式驗收資料集的跑報與延遲 / 品質統計仍依 §1.3.4 與 §3.3.2 規劃，留待實際驗收階段再回填。

進一步補強的實機與驗證成果如下：

5. **自動化 acceptance 測試全綠**：2026-04-21 以 `pnpm verify:acceptance` + `pnpm test:integration` 跑完後，Unit acceptance 6、MCP contracts 51、Integration 260（1 skipped pre-existing）、其中 TC-01~20 與 TC-UI-01 合計 42 個 assertions 全綠。明細見 §3.3.2.1 表 3-6a / 3-6b；現階段驗證重點是流程與治理的結構式正確性，不以此宣稱已完成實模型品質驗收。
6. **實機截圖與操作證據已整理完成**：2026-04-21 於 local dev 環境拍下七張主畫面（圖 3-1 ~ 3-7），覆蓋登入、問答 empty onboarding、文件管理（三 lifecycle 狀態）、Token 管理、成員管理（三級角色）、訪客政策 dial、AI Gateway 用量（graceful error 降級）。其中 `/chat` 以 empty onboarding 呈現初始狀態、`/admin/usage` 以 graceful error 呈現降級狀態；含回答與含 gateway 資料的 loaded 畫面則列為正式驗收補充證據。
7. **報告結構與驗收章節已完成對齊**：第二至第四章已補入自動化驗證覆蓋、實機截圖、EV runbook 指向與表 4-1 狀態分級，使成果說明、驗收依據與後續補件邏輯能互相對照。

本次整體修訂亦補強以下內容：

8. **§3.3.2.3 驗收延後項收束契約**：新增表 3-10，明確每一項延後項（表 3-7 / 3-8 統計、圖 3-2 / 3-7 補拍、架構圖、組員心得、封面日期、套件版本）之結案環境、執行者、資料集、通過門檻與預計觸發時機，防止延後項成為無限期空殼。
9. **§2.4.5 部署成本與容量規劃**：新增表 2-29 情境化月度運營成本估算與表 2-30 Scale Envelope，作為部署規劃、擴展觸發點與答辯討論的參考依據；這些數字屬估算與規劃，不等同正式營運統計或正式容量驗證結果。
10. **附錄 E 實模型選型參考**：新增表 E-1 Workers AI 候選模型對照，列出候選模型、選型 gate 與鎖定流程，供後續接入實模型時對照；此附錄屬候選規劃，不代表本版已實際部署這些模型。
11. **§4.1.2 特色分級敘述**：8 項技術特色改以「已達結構式驗證 / 延伸驗證邊界」兩級分級呈現，每項標註對應 TC 測試證據，與 §4.1.1 表 4-1 三級狀態分級互補。
12. **§3.2.3 響應式職責切分敘述**：明確本節 7 張截圖以 desktop 為主、跨 viewport 證據由 EV-06 獨立承擔，避免讀者誤判響應式缺失。
13. **其他清理**：圖表目錄總數校正為 62 張、表 2-9 保留編號從圖表目錄去除佔位、參考文獻 web 資源統一改 accessed date 格式。
```
...
目前尚需補齊的工作主要集中在正式驗收圖表、長期營運觀測與答辯支撐材料；其中圖表、截圖與正式統計屬交付前整理項，並不改變本報告已完成的架構、流程與自動化驗證結論，但仍需在部署環境中再次核對平台能力與實際限制。就交付清單而言，仍需補齊的重點如下：

1. 圖 1-1、圖 1-2、圖 2-1、圖 2-2、圖 2-3、圖 2-4 六張架構／流程圖仍待製作。
2. 表 3-7、表 3-8 的正式驗收統計仍待以正式驗收資料集回填。
3. 圖 3-2 的「含回答與引用卡片版本」及圖 3-7 的「含實際用量資料版本」仍待於適當環境補拍。
4. EV-01、EV-04、EV-06 所需之最終部署、保留期限清理、響應式與無障礙整體證據仍待整包彙整。
5. 定稿排版後仍需核對封面日期、目錄頁碼，以及首次通過核心閉環驗證時的最終套件小版本號與實際模型名稱。
```
...
1. 附錄 B 已先補齊 `Acceptance ID`、`gold facts`、必要引用、不可犯錯與預期 `http_status`；後續只需凍結初始驗證資料集、校準資料集與正式驗收資料集的使用邊界與資料來源，不再變動欄位語意。
2. 180 天稽核保留（`citation_records.expires_at` 直接承載 retention window）與 `citationId` 全域唯一性等治理語意已先封口，避免實作中途重改資料模型；對話刪除與 `content_text` 清理已於本輪完成，後續重點改為 retention window 的長週期驗證與部署環境 closeout。
3. 核心補強仍以「文件發布 → Web 問答 → 引用回放 → current-version-only → `restricted` 隔離 → redaction」六步閉環為主；`searchKnowledge`、`listCategories`、token 管理 UI 與管理儀表板則屬後續規劃。
4. 圖面、第三章介面截圖、第四章驗收狀態與答辯簡報皆應在核心閉環真正跑通後再補齊，避免以假資料或示意版面反向綁架實作。
```

---

## 0108 5.2.4 Fallback Synthesizer 取捨說明

```markdown
### 5.2.4 Fallback Synthesizer 取捨說明

現階段核心實作刻意採「以 `models.defaultAnswer` / `models.agentJudge` 角色常數對應之 fallback 合成器與結構式判斷器」取代實際 LLM 呼叫，待後續實模型與營運觀測階段再接入 Vercel AI SDK 與 Workers AI 實模型（§2.1.2 結尾明載）。此取捨並非技術能力不足，而是基於以下工程考量：
...
2. **答辯範圍收斂**：實模型串接涉及 prompt 工程、token 成本觀測、延遲分布、模型版本鎖定等獨立議題，將其切出至後續階段能讓現階段答辯聚焦「架構正確性 + 治理機制 + 契約穩定性」，不被模型回答品質細節分散。
3. **成本控制**：規劃期尚未鎖定最終模型（Workers AI 模型清單與 alias 可能變動），fallback 合成器可支援初始驗證與校準資料集而不累積 token 費用；實模型僅於正式驗收與 Preview / Staging 環境實際呼叫。
4. **工程誠實**：此取捨是 Spec-Driven Development 分階段驗收方法論的具體體現，也是實務專案常見之「先確認架構可運作，再接真模型」工程思路；答辯時不宣稱現階段即已完成實模型品質驗證，而是以「結構式正確性」為驗收基準，實模型延遲與品質留待後續階段以獨立報告佐證。

上述取捨於實作與答辯階段均應清楚溝通：現階段的驗收證據來自結構式判斷器運作紀錄與 fallback 合成器輸出，對應實模型接入後的回答品質基線，將於後續擴充階段另行建立對照報告，不影響現階段核心驗收結論的成立。
...
[4] Anthropic, "Model Context Protocol Specification," https://modelcontextprotocol.io/specification, accessed 2026-04-21.

[5] Cloudflare, "Cloudflare Workers Documentation," https://developers.cloudflare.com/workers, accessed 2026-04-21.

[6] Cloudflare, "Cloudflare Workers AI Documentation," https://developers.cloudflare.com/workers-ai, accessed 2026-04-21.

[7] Cloudflare, "Cloudflare AI Search Documentation," https://developers.cloudflare.com/ai-search/, accessed 2026-04-21.

[8] Cloudflare, "Cloudflare D1 Documentation," https://developers.cloudflare.com/d1, accessed 2026-04-21.

[9] Cloudflare, "Cloudflare R2 Documentation," https://developers.cloudflare.com/r2, accessed 2026-04-21.

[10] Vercel, "AI SDK Documentation," https://sdk.vercel.ai, accessed 2026-04-21.

[11] Nuxt Team, "Nuxt 4 Documentation," https://nuxt.com, accessed 2026-04-21.

[12] NuxtHub, "NuxtHub Documentation," https://hub.nuxt.com, accessed 2026-04-21.

[13] Better Auth, "Better Auth Documentation," https://better-auth.com, accessed 2026-04-21.

[14] Drizzle Team, "Drizzle ORM Documentation," https://orm.drizzle.team, accessed 2026-04-21.

[15] Nuxt Modules, "@nuxtjs/mcp-toolkit Documentation," https://mcp-toolkit.nuxt.dev, accessed 2026-04-21.

[16] Nuxt Team, "Working with AI: Nuxt MCP Server," https://nuxt.com/docs/4.x/guide/ai/mcp, accessed 2026-04-21.

[17] Nuxt UI Team, "MCP Server - Nuxt UI," https://ui.nuxt.com/docs/getting-started/ai/mcp, accessed 2026-04-21.

[18] Kao, C.-L., "spectra: A Desktop App for Spec-Driven Development (based on OpenSpec)," https://github.com/kaochenlong/spectra-app, accessed 2026-04-21.

[19] Fission AI, "OpenSpec: Spec-Driven Development for AI Coding Assistants," https://github.com/Fission-AI/OpenSpec, accessed 2026-04-21.
...
[25] Cloudflare, "Workers Binding - Cloudflare AI Search Documentation," https://developers.cloudflare.com/ai-search/usage/workers-binding/, accessed 2026-04-21.

[26] Cloudflare, "Release Notes - Cloudflare AI Search Documentation," https://developers.cloudflare.com/ai-search/platform/release-note/, accessed 2026-04-21.

[27] Cloudflare, "kimi-k2.5 - Cloudflare Workers AI Documentation," https://developers.cloudflare.com/workers-ai/models/kimi-k2.5/, accessed 2026-04-21.

[28] Cloudflare, "MCP - Cloudflare AI Search Documentation," https://developers.cloudflare.com/ai-search/usage/mcp/, accessed 2026-04-21.
...
本附錄先建立 20 筆初始驗證案例，供欄位檢查與早期 dry run 使用；正式驗收前應另建立 30–50 筆正式驗收測試集。若需校準門檻、prompt 或模型路由，應使用獨立校準資料集，不得以正式驗收資料集反覆調參；答辯展示案例集可自正式驗收資料集挑選，但不得因展示需求回改驗收規則。以下表格已先補齊 `Acceptance ID`、`gold facts`、必要引用、不可犯錯與預期 `http_status`，作為後續逐案判分來源。
...
正式擴充正式驗收資料集時，除補足問答案例外，亦需建立對應的 `EV-xx` 補充證據，處理 OAuth／allowlist 變更後的權限重算、publish no-op / 失敗 rollback、rate limit、stale 對話重算與 rich format canonical snapshot 驗證等不適合只用單一問句描述的驗收項目。
...
| 2    | 切換至管理員測試帳號登入，進入「成員管理」畫面，將步驟 1 之訪客升格為 Member                                                       | 成員列表顯示該帳號，role 變更為 Member；`admin_source` 顯示 allowlist / promotion                    | A08（含三級角色擴充）              |
...
本附錄補充正文 §2.4.1 與表 2-25 所列之部署環境與組態來源，從運維操作視角完整交代：部署時應設定哪些環境變數與憑證、初次部署與日常部署的正確順序，以及四類災難情境的復原程序。本附錄採敘述性語氣說明「為什麼如此設計」與「邊界條件」；可直接 copy-paste 執行的完整指令序列與驗證輸出，請交叉參考 `docs/verify/DEPLOYMENT_RUNBOOK.md` 與 `docs/verify/DISASTER_RECOVERY_RUNBOOK.md`，避免與本附錄分歧維護。

本附錄與表 2-25 採互補分工：表 2-25 以「Local / Staging / Production」三欄呈現組態真相來源的差異，偏重設計原則（不得共用資源、祕密值不寫死等）；表 D-1 則從「運維層」列出每個環境變數的用途、範例格式、敏感度與設定管道，協助新 operator 在執行部署時知道該把哪些值放到何處。兩表欄位不重複：表 2-25 不列變數名稱，表 D-1 不重述環境差異原則。
...
| `CLOUDFLARE_ACCOUNT_ID`                    | `/api/admin/usage` 用於讀取 Analytics API 的帳號識別碼                                                       | Cloudflare account ID               | 低     | `wrangler secret put`                            |
...
「敏感度」欄之「高」代表外流即需立即輪替並通知相關人員；「中」代表外流會洩漏特定個資或組織資訊，應盡速輪替；「低」代表本身不是祕密，但仍不宜隨意公開。Feature flags 在現階段的預設狀態已對齊表 2-25「不納入目前範圍之功能預設關閉」之原則。

AI Gateway 相關變數屬 `add-ai-gateway-usage-tracking` 階段引入之 observability 基礎設施；若 `NUXT_KNOWLEDGE_AI_GATEWAY_ID` 未設，系統仍可正常運作但 `/admin/usage` 會呈現 graceful error placeholder（圖 3-7 佐證）。
```
...
初次部署係指 Cloudflare account 尚未建立任何相關資源、尚無任何 D1 / R2 / KV 綁定、且未執行過任何 migration 的狀態。初次部署流程僅在新環境（如 Staging 首次建立、或正式網域遷移至新 account）執行，完成後轉為 §D.2 日常部署流程。

初次部署分五個階段，彼此具順序依賴：資源建立 → Schema migration → 憑證設定 → OAuth redirect URI 設定 → 首次部署與煙霧測試。以下說明每階段之重點與邊界；完整指令見 `docs/verify/DEPLOYMENT_RUNBOOK.md` §2。
```

---

## 0125 D.1.1 Cloudflare 資源建立

```markdown
#### D.1.1 Cloudflare 資源建立

現階段依賴三類 Cloudflare 邊緣資源與一個 AI Search 索引，名稱須與 `wrangler.jsonc` 的 binding 宣告一致。
...
## 0127 D.1.3 Runtime Secrets 與憑證設定
...
## 0128 D.1.4 Google OAuth Redirect URI 設定
...
CI workflow（`.github/workflows/deploy.yml`）之核心 job 結構可參照以下節選；完整版本見 repo 內實際檔案。

```yaml
jobs:
  ci:
    # format / lint / typecheck / test 全綠
  deploy-production:
    needs: ci
...
在補齊上述 build-time env 後，production 首頁與 passkey register route 已恢復，但 2026-04-22 live 驗證仍發現第二層 blocker：passkey-only 使用者於 `/account/settings` 執行刪帳 reauth 時，`GET /api/auth/passkey/generate-authenticate-options` 回 `200`，`POST /api/auth/passkey/verify-authentication` 則回 `500`，Worker log 顯示 `TypeError: a14.ownKeys is not a function or its return value is not iterable`。因此本地 hotfix 已將 `better-auth` 與 `@better-auth/passkey` 升至 `1.6.7`，並在 `pnpm-workspace.yaml` 以 workspace override 鎖定 `better-call = 1.3.5`、同步將 `vite` / `vitest` manifest specifier 對齊至 `0.1.19`，避免 edge/runtime 與測試工具鏈再次漂移；同輪也把 `pnpm test` 主路徑調整為不帶 coverage，另以 `pnpm test:coverage` 保留顯式 coverage 入口，避免預設測試流程再出現 mixed-version warning。自動化驗證目前覆蓋三層：`test/unit/better-auth-passkey-hotfix-version.test.ts` 會檢查 package specifier、coverage 版本、workspace override、`pnpm-lock.yaml` 的實際 resolved entries，以及舊版 `better-auth` / `@better-auth/passkey` / `better-call` / `@vitest/coverage-v8` / `vite` / `vitest` 未重新混入；`test/integration/passkey-verify-authentication-hotfix.spec.ts` 會在 Node test environment 直接匯入 `@better-auth/passkey` 的 `verifyPasskeyAuthentication` endpoint，使用真實 ES256 WebAuthn fixture 驗證 success path 與 session cookie wiring 不會在目前依賴組合下失敗；`test/integration/passkey-authentication-flow.spec.ts` 與 `test/integration/account-self-delete.spec.ts` 則維持 passkey wiring invariant 與 delete-account reauth-window 的結構保護，`pnpm build` 亦已通過。這些自動化能降低依賴與 endpoint-level 回歸風險，但仍**不能等同於 Cloudflare Worker live runtime 驗證**。

2026-04-23 追驗結果進一步證明：`v0.28.2` 的 production app deploy 已成功完成，GitHub Actions run `24790139030` 的 `deploy-production` 與 `smoke-test` 皆為 green，production runtime 的 `window.__NUXT__.config.public.knowledge.features.passkey` 也已切回 `true`。以 Playwright virtual authenticator 實測，passkey-first 使用者可完成 `generate-register-options`、`verify-registration`、登入後也能正常載入 `/account/settings`；但同一條 reauth 路徑仍在 `POST /api/auth/passkey/verify-authentication` 回 `500`。本輪用 `wrangler tail nuxt-edge-agentic-rag --method POST` 重放 production flow，Cloudflare Worker 再次吐出完全相同的 Better Auth 錯誤：

- `TypeError: a14.ownKeys is not a function or its return value is not iterable`
- `# SERVER_ERROR: TypeError: a14.ownKeys is not a function or its return value is not iterable`

這表示 `1.6.7` hotfix 雖已部署，**但在 Cloudflare Worker live runtime 中仍未消除此錯誤**。同一個 deploy workflow 的 docs custom domain sync 另外仍因 Cloudflare API `403 Authentication error` 失敗，造成 workflow 紅燈，但不影響 app production 站點已上新版。結論是：`fk-cascade-repair-for-self-delete` 仍卡在 production live reauth，8.5 / 8.6 / 8.7 不能勾；下一步不再是單純 redeploy，而是要針對 `verify-authentication` 在 Worker runtime 的相依組合 / bundling 根因繼續 debug。

2026-04-23 稍晚的本地 debug 進一步縮小可疑面：bundle sourcemap 已證實 production artifact 內實際被打包的是 `better-auth@1.6.7` / `@better-auth/passkey@1.6.7` / `better-call@1.3.5`，舊的 `better-auth@1.5.0-beta.13` 僅存在於 `@better-auth/cli` 開發相依樹，並未直接進入 runtime bundle。因此本輪新增 `server/utils/better-auth-safe-logger.ts`，在 Better Auth `logger.log(level, message, ...args)` 邊界把所有附帶物件先安全轉成字串，並在 sink 本身 throw 時吞掉例外、改走 fallback log，避免 Worker console / serializer 再把 passkey reauth 的原始錯誤二次放大成 `500`。後續又再把 logger 策略收斂成 **plain console sink + `disableColors: true`**：移除原先仍可能觸發 Worker runtime color/env probing 的 `consola` 預設 sink，改為直接輸出 `console.debug/info/warn/error`，並顯式關閉 Better Auth color probing，避免 `getColorDepth()` 再碰到 Workers `env` proxy trap。同步新增 `test/unit/better-auth-safe-logger.test.ts` 驗證 broken proxy / throwing sink / `disableColors` 三類情境，以及 `server/auth.config.ts` 已確實接入該 logger；`test/integration/passkey-verify-authentication-hotfix.spec.ts` 與 `pnpm build` 亦重新通過。

更重要的是，這次 mitigation 已在本地 Cloudflare Worker preview 出現正向訊號：先前以 `wrangler dev` 啟動 `.output` 產物時，會在 `getColorDepth -> createLogger$1` 鏈路直接重現 `TypeError: a14.has is not a function`；套用 `disableColors + plain console sink` 後，`npx wrangler --cwd .output dev` 已能正常啟動，首頁 `GET /` 亦回 `200`，SSR HTML 內的 `window.__NUXT__.config.public.knowledge.features.passkey` 保持 `true`。這證明本輪修補至少已拔除一個會在 Worker runtime 啟動或 logging 路徑上即時觸發的崩點；但它仍屬 **local mitigation**，尚待下一次 deploy 後重跑 production `POST /api/auth/passkey/verify-authentication`，確認是否直接恢復 `200`，或至少把目前被遮蔽的底層錯誤顯性化為可診斷的 `4xx/5xx`。

2026-04-23 晚間的下一輪 hotfix 已把可疑面再縮小到 Better Auth catch-all router 與 Worker request/body adapter 邊界：新增 app 自己的精準 route [server/api/auth/passkey/verify-authentication.post.ts](/Users/charles/offline/yuntech-project/repo/nuxt-edge-agentic-rag/server/api/auth/passkey/verify-authentication.post.ts:1)，不再讓這條路徑走 `@onmax/nuxt-better-auth` 注入的 `/api/auth/**` 通用 handler。第一版 override 先直接呼叫 `auth.api.verifyPasskeyAuthentication({ asResponse: true, headers, body })`，證明 route precedence 可被 app exact route 接管；但為了再縮短與 Better Auth 原生 request contract 的距離，最新本地版已進一步改成在 Nitro route 內建立乾淨的 `Request`，並交由 `auth.handler(new Request(...))` 處理。對應 helper 放在 [server/utils/passkey-verify-authentication.ts](/Users/charles/offline/yuntech-project/repo/nuxt-edge-agentic-rag/server/utils/passkey-verify-authentication.ts:1)，搭配單元測試 [test/unit/passkey-verify-authentication.test.ts](/Users/charles/offline/yuntech-project/repo/nuxt-edge-agentic-rag/test/unit/passkey-verify-authentication.test.ts:1) 驗證 forwarding request 會保留原始 URL / cookie / origin，且 body 在 app 邊界先驗證至少具有 `response` record，再把 top-level `response` materialize 成 plain object 後重新序列化，避免 opaque proxy / trap 物件穿進 Worker runtime 的下一層。

後續在 `pnpm check` 的 typecheck 階段又暴露出另一個邊界：`serverAuth(event)` 的 `AuthInstance` 型別未顯式暴露 `verifyPasskeyAuthentication`，因此 helper 已收斂成 runtime guard，改以檢查 `auth.handler` 是否存在；若 route 已啟用但 handler 缺失，則明確回 `503 Passkey authentication unavailable`，避免把「module catch-all 被覆蓋」誤演成新的 silent `500`。再下一輪 CI 對齊驗證又抓到 Node unit runner 會在載入 util 時找不到 `h3` bare import，因此 `h3` 錯誤包裝已回收至 route handler，util 改丟自家 `PasskeyVerifyAuthenticationRouteError`，避免 test-only module resolution 把 release 擋在 CI gate 之前。`pnpm check`、`pnpm test test/unit/passkey-verify-authentication.test.ts`、`pnpm test:unit`、`pnpm build` 目前都已通過，且本地 preview 實測 `POST /api/auth/passkey/verify-authentication` 對空 JSON 會優先命中新 route 並回 `400 Passkey authentication payload invalid`，證明 route precedence 仍成功覆蓋 module catch-all；同時 feature 關閉時的既有 `404` 語意也已由 guard 保留。

同日晚間對 local Worker preview 再做一次完整 WebAuthn flow 追驗，也排除了另一個容易誤導 debug 的假線索：以 `http://localhost:8790` 打開 preview、使用 Playwright virtual authenticator 進行 passkey-first 註冊時，`GET /api/auth/passkey/generate-register-options` 會回 `200`，但 `POST /api/auth/passkey/verify-registration` 立即回 `500 Failed to verify registration`，Worker log 明確指出 `Unexpected registration response origin "http://localhost:8790", expected "http://agentic.yudefine.com.tw"`。這證明當前 `.output` preview artifact 仍固化了 production origin / site URL，不能直接拿來當作 local WebAuthn full-flow 的真假判準；它能驗 routing precedence、不能驗真實 ceremony 成敗。結論因此沒有改變：這版 `auth.handler(new Request(...))` mitigation 尚未 deploy，production `a14.ownKeys...` 是否解除仍待下一次發布後驗證。

2026-04-23 深夜的下一輪 live trace 終於把 root cause 再縮到更具體的 Worker-only 路徑。`v0.28.7` 已實際 deploy 到 production，`smoke-test` 也為 green；重新用 Playwright virtual authenticator 重放完整 flow，passkey-first 註冊仍成功，`/account/settings` 也能載入，`GET /api/auth/passkey/generate-authenticate-options` 仍回 `200`，但 `POST /api/auth/passkey/verify-authentication` 依舊回 `500`。關鍵在於：`@better-auth/passkey` 原始碼的 `verifyPasskeyAuthentication()` 把 `verifyAuthenticationResponse(...)`、`createSession(...)`、`findUserById(...)`、`setSessionCookie(...)` 全包在同一個 `try` 內，而 catch 分支理論上應回 `400 AUTHENTICATION_FAILED`；production 實際卻是 `500`，表示 catch 裡有第二個爆點。進一步對照 `better-auth` 原始碼可見 `setSessionCookie()` 內會呼叫 `setCookieCache()`，其流程包含 `filterOutputFields(structuredClone(session.session))` 與 `parseUserOutput(... -> filterOutputFields(structuredClone(user)))`。`@better-auth/core/utils/db.mjs` 的 `filterOutputFields()` 正是直接對輸入做 `structuredClone(data)`，若 Worker adapter 回傳的是帶 proxy trap 的 row/object，就極可能在這裡重現 `a14.ownKeys is not a function or its return value is not iterable`。

因此本輪採取新的最小 workaround：在 [server/auth.config.ts](/Users/charles/offline/yuntech-project/repo/nuxt-edge-agentic-rag/server/auth.config.ts:209) 顯式設定 Better Auth `session.cookieCache.enabled = false`，讓 passkey verify-authentication 只產生 signed session token cookie，不再走會 `structuredClone(session/user)` 的 cookie-cache 分支；同時把 [better-auth-safe-logger.ts](/Users/charles/offline/yuntech-project/repo/nuxt-edge-agentic-rag/server/utils/better-auth-safe-logger.ts:1) 再收斂成「單字串 console sink + args serialization 外層再包一次 try/catch」，避免 catch-path logging 自己再次把原始錯誤放大成 opaque `500`。對應新增 [test/unit/better-auth-worker-cookie-cache-hotfix.test.ts](/Users/charles/offline/yuntech-project/repo/nuxt-edge-agentic-rag/test/unit/better-auth-worker-cookie-cache-hotfix.test.ts:1)；`test/unit/better-auth-safe-logger.test.ts`、`test/unit/passkey-verify-authentication.test.ts`、`pnpm check`、`pnpm build` 也都重新通過。這版尚未 redeploy，production closeout 仍待下一次 release 後重跑。

2026-04-23 深夜 closeout 最終完成。`v0.28.11` 先證實 production backend path 已恢復：passkey-first 註冊、`generate-authenticate-options`、`verify-authentication`、`/api/auth/account/delete` 與 `/api/auth/sign-out` 都回 `200`，production D1 也確實留下 `member_role_changes.reason = 'self-deletion'` tombstone，並把該 test user 的 `"user"` / `passkey` / `mcp_tokens` rows 全數清空；但 UI 仍殘留在 `/account/settings`，說明 server session 雖然已清掉，SPA 端的 auth atom / page state 沒有完全重置。對照 live diagnostics 可見：URL 已切到 `/`、`/api/auth/get-session` 回 `null`，body 卻還停留 account settings 舊畫面，因此 root cause 不再是 Better Auth Worker verify，而是 delete 後只做 `navigateTo('/')` 的 soft navigation 不足以清空 stale auth UI。

最終修補收斂成 [DeleteAccountDialog.vue](/Users/charles/offline/yuntech-project/repo/nuxt-edge-agentic-rag/app/components/auth/DeleteAccountDialog.vue:1) 的 hard redirect：刪除成功後沿用 `signOut({ onSuccess })`，但不再依賴父頁面 `@deleted -> navigateTo('/')`，而是於 client 端直接 `window.location.replace('/')`；[account/settings.vue](/Users/charles/offline/yuntech-project/repo/nuxt-edge-agentic-rag/app/pages/account/settings.vue:1) 也同步移除多餘的 `deleted` 導頁 callback，避免父子雙重 navigation 競態。`v0.28.12` deploy 後再次以 Playwright virtual authenticator 重放 production full flow：passkey-first test user `td011-prod-moahx2b7` 註冊成功、插入 production `mcp_tokens` 測試列後完成 reauth，自刪時 `verify-authentication` / `account/delete` / `sign-out` 皆為 `200`；最終頁面確實回到 `/` 登入畫面，`/api/auth/get-session = null`，首頁 body 恢復「知識問答系統 / 使用 Google 帳號登入 / 使用 Passkey 登入 / 使用 Passkey 註冊新帳號」文案。D1 查核同時證實 `user_id = '0RxvCuf1RldbTXcE9vWFgfbB6iQ4eX7T'` 的 latest tombstone `reason = 'self-deletion'`，且 `user_count = 0`、`passkey_count = 0`、`token_count = 0`。至此 `fk-cascade-repair-for-self-delete` 的 production closeout 與 TD-011 已全部收斂完畢。

````

---

## 0133 D.2.3 Post-deploy 煙霧測試與 Tag 命名
...
本節分四類子節說明發生事故時之復原程序。表 D-3 彙整四類情境之觸發信號與決策路徑，作為 operator 拿到 incident 後之第一步分類依據。
...
## 0138 D.3.4 Secrets 與 Env Var 還原
...
`ADMIN_EMAIL_ALLOWLIST` 誤刪若導致自身亦被踢出管理介面，須透過 Cloudflare Dashboard 直接編輯 Variables and Secrets 區塊加回自身 email；此為唯一不透過 `wrangler` CLI 操作之 fallback 路徑，避免事故中陷入「自己鎖自己在門外」之窘境。
...
本附錄作為 §2.2.3.1 模型分工的量化補充。現階段核心閉環以 fallback synthesizer 運行，實模型接入屬後續實模型與營運觀測工作；為避免答辯時「接入哪個模型」成為空白，本附錄整理候選模型與選型規則，供接入時對照。
```
...
以下清單以 2026-04 時點 Cloudflare Workers AI 官方模型頁 [6][27] 可用模型為主；模型清單與 alias 可能變動，實際接入前須再次核對官方最新公告。本附錄屬候選規劃與選型參考，不代表本版已實際部署下表模型。
...
2. **延遲 gate**：`models.defaultAnswer` 須在 Preview 環境達成「首字延遲 P50 <= 1.5s」（表 2-28 觀測指標）；`models.agentJudge` 允許較寬鬆但 completion latency P95 不應超過 6s。
3. **結構化輸出 gate**：`models.agentJudge` 須能穩定回傳 JSON schema（`{ shouldAnswer, reformulatedQuery? }`）；小樣本測試若出現明顯 schema 破格，即應淘汰該模型。
4. **成本 gate**：以 §2.4.5.1 表 2-29 的情境化估算作初步判斷；若候選模型推估超過年度預算，則降階為較小模型或啟用 AI Gateway cache。正式採用前仍須以實測數據回填。
5. **中英文 gate**：附錄 B 正式驗收資料集含中文知識庫內容，候選模型須在中文 gold facts 命中率達品質驗收 > 80%（表 2-28 Answer Correctness）。
```
...
2. 更新本文件 §2.2.3.1 表 2-17 的「實際模型鎖定原則」欄為具體 alias，並補充鎖定理由（延遲 / 成本 / 品質 trade-off 摘要）。
3. 於 `query_logs.config_snapshot_version` bump 一次（`v1.x.0`），作為鎖定前後統計不可混算之分界。
4. 跑一輪正式驗收資料集，將結果回填表 3-7、表 3-8 與 §3.3.2 前言。
...
1. **Claude / GPT-4o / Gemini 雲端 API**：涉及資料外送、需治理閘道、會破壞「現階段不啟用跨雲 LLM API」之核心命題（§1.1.4）。
...
上述替代方案列入 §4.2.2 架構演進方向中「Cloud fallback」的候選池，需獨立 feature flag 與治理驗證。
```
