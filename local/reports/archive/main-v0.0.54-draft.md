...
表 18 內部 REST API 方法清單 ..................................... 頁碼由文書軟體產生

表 19 MCP 現階段核心工具 ..................................... 頁碼由文書軟體產生

表 20 Agent 模型角色分工 ..................................... 頁碼由文書軟體產生

表 21 第一輪檢索預設參數 ..................................... 頁碼由文書軟體產生

表 22 Self-Correction 重試參數 ..................................... 頁碼由文書軟體產生

表 23 共享設定常數與 feature flag ..................................... 頁碼由文書軟體產生

表 24 分段式決策門檻(現行做法：以 retrieval_score 單一指標 + judge 結構式回傳) ..................................... 頁碼由文書軟體產生

表 25 文件生命週期狀態轉移規則(現階段：以 document_versions.index_status + sync_status 承擔同步任務狀態機) ..................................... 頁碼由文書軟體產生

表 26 開發里程碑與週次規劃 ..................................... 頁碼由文書軟體產生

表 27 allowed_access_levels 存取矩陣 ..................................... 頁碼由文書軟體產生

表 28 部署環境與組態真相來源 ..................................... 頁碼由文書軟體產生

表 29 與純雲端 LLM 方案比較 ..................................... 頁碼由文書軟體產生

表 30 平台限制與因應方式 ..................................... 頁碼由文書軟體產生

表 31 效能與品質驗收指標 ..................................... 頁碼由文書軟體產生

表 32 現階段情境化月度運營成本估算 ..................................... 頁碼由文書軟體產生

表 33 現階段 Scale Envelope 與擴展觸發點 ..................................... 頁碼由文書軟體產生

表 34 硬體環境規格 ..................................... 頁碼由文書軟體產生

表 35 軟體環境版本 ..................................... 頁碼由文書軟體產生

表 36 開發工具版本 ..................................... 頁碼由文書軟體產生

表 37 系統功能模組說明 ..................................... 頁碼由文書軟體產生

表 38 知識庫管理操作按鈕確認策略 ..................................... 頁碼由文書軟體產生

表 39 核心測試情境設計 ..................................... 頁碼由文書軟體產生

表 40 自動化測試覆蓋 ..................................... 頁碼由文書軟體產生

表 41 TC / UI-state 測試檔對照 ..................................... 頁碼由文書軟體產生

表 42 實測情境彙總表(欄位定義；現階段以表 40 / 41 結構式自動化測試承擔) ..................................... 頁碼由文書軟體產生

表 43 TC 逐案測試結果表(欄位定義；現階段以表 41 結構式驗證代替；正式驗收後填入) ..................................... 頁碼由文書軟體產生

表 44 EV 補充證據項目 ..................................... 頁碼由文書軟體產生

表 45 交付版驗收證據整理 ..................................... 頁碼由文書軟體產生

表 46 MCP tool-selection eval 資料集覆蓋 ..................................... 頁碼由文書軟體產生

表 47 v2 baseline 結果 ..................................... 頁碼由文書軟體產生

表 48 驗收對照項目清單 ..................................... 頁碼由文書軟體產生

表 49 中小企業 ERP 痛點與本系統產品特色對照 ..................................... 頁碼由文書軟體產生

表 50 MCP scope 授權對照 ..................................... 頁碼由文書軟體產生

表 51 MCP 錯誤碼定義 ..................................... 頁碼由文書軟體產生

表 52 初始驗證測試資料集 ..................................... 頁碼由文書軟體產生

表 53 答辯示範劇本步驟 ..................................... 頁碼由文書軟體產生

表 54 部署環境變數清單 ..................................... 頁碼由文書軟體產生

表 55 現階段必要 Cloudflare 資源清單 ..................................... 頁碼由文書軟體產生

表 56 災難情境與對應復原路徑 ..................................... 頁碼由文書軟體產生

表 57 Workers AI 候選模型對照 ..................................... 頁碼由文書軟體產生
...
| 表 42、表 43                     | 以 TC / EV 證據整理核心驗收結果                              | 已具備交付版驗收依據；更大樣本統計列為營運觀測             |
