...
| 項目                         | 本報告處理方式                                   | 成果結論定位                                               |
| ---------------------------- | ------------------------------------------------ | ---------------------------------------------------------- |
| 目錄、圖表索引與正式頁碼     | Markdown 保留章節與圖表順序，Word / PDF 產生頁碼 | 已具備交付版排版結構；頁碼由最終文書格式產生               |
| 圖 1 至圖 6                  | 以 Mermaid 圖納入正文                            | 已具備架構、流程與資料模型說明                             |
| 表 41、表 42                 | 以 TC / EV 證據整理核心驗收結果                  | 已具備交付版驗收依據；更大樣本統計列為營運觀測             |
| 圖 8 與圖 13                 | 呈現目前環境下的問答主畫面與用量頁代表狀態       | 已具備使用者介面與用量頁代表證據                           |
