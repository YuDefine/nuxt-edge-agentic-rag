...
#   序列跑等於把每個 check 的耗時相加。<consumer-a> 2026-07-26 實測序列 ≈ 98s，其中
...
#
#   ⚠ 上面那組數字是 2026-07-26 的量測，**已經過期**：<consumer-a> 2026-09-07 重量得
...
#   逐 consumer 由 registry/consumers.json 的 push_timeout_ms 覆寫（<consumer-a> 900s）。
#
