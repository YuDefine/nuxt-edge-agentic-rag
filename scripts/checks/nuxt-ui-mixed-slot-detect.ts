#!/usr/bin/env node
// 🔒 LOCKED — managed by clade · Source: vendor/scripts/checks/nuxt-ui-mixed-slot-detect.ts · 改這裡無效，下次 propagate 會覆寫；請改 $CLADE_HOME/vendor/scripts/checks/nuxt-ui-mixed-slot-detect.ts
// CLADE:VENDOR-SCRIPT
/**
 ...
 * typecheck / lint 全綠（<consumer-a> /reports/daily-machining 空白 18 天實證）。
 *
