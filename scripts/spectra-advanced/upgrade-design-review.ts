 ...
 *
 * Usage:
 *   node scripts/spectra-advanced/upgrade-design-review.ts             # report + upgrade in place
 *   node scripts/spectra-advanced/upgrade-design-review.ts --dry-run   # report only
 *   node scripts/spectra-advanced/upgrade-design-review.ts --json      # machine-readable report
 *
 * Scope:
