...
spectra-apply Phase Dispatch 規則仰賴 phase purity：UI view phase（component / page / view / layout / styling）由主線 Claude Code 自己做、非 view phase 派 codex GPT-5.6-sol high。混雜 phase 會破壞 dispatch 邊界。
