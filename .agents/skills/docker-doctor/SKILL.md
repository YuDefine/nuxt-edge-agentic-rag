---
name: docker-doctor
description: "Use when 建立 / 審查 Dockerfile、debug container build/runtime/deploy、或跑 fleet Docker health check。觸發詞：docker-doctor、檢查 Docker、container 壞了、OOM、restart loop。"
effort: medium
license: MIT
metadata:
  author: clade
