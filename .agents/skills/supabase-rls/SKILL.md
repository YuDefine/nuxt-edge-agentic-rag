...
description: >-
  ...
  NOT for schema DDL 或 migration 檔本身的規範（CREATE TABLE / ALTER TABLE
  / CREATE INDEX / CREATE FUNCTION、supabase migration new）——那走
  supabase-migration；RLS policy 即使寫在 migration 檔裡，policy 的內容設計仍走本 skill。
---
