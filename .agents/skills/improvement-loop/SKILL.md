...
description: Use when 動 improvement-digest / closure-scanner / emit-pre-commit-signal、vendor/signals / vendor/ledger / docs/digests/、bin/vp、bin/clade-gate，或 propose 前 codify 新標準、archive 後補 ledger。
effort: medium
license: MIT
metadata:
  author: clade
