---
name: data-sanity
description: "Use when running spectra Design Review, before /spectra-archive, or ad-hoc on changes touching paginated queries. Detects client-server schema mismatch (e.g. perPage: 200 vs max(100))."
effort: medium
metadata:
  author: clade
  version: "1.0"
