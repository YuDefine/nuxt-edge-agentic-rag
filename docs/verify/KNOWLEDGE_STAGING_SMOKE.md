# Knowledge Staging Smoke

## Purpose

在 staging 或 preview 環境驗證 bootstrap-v1-core-from-report 的最小閉環，覆蓋 allowlist、publish、web answering、MCP ask/replay/search/categories 與治理規則。

## Preconditions

- staging 使用獨立的 D1、R2、KV、AI Search bindings
