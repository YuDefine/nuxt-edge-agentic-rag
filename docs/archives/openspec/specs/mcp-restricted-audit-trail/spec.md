# mcp-restricted-audit-trail Specification

## Purpose

TBD - created by archiving change 'tc-acceptance-followups'. Update Purpose after archive.
...
<!-- @trace
source: tc-acceptance-followups
updated: 2026-04-19
code:
  - server/utils/mcp-replay.ts
  - server/api/mcp/chunks/[citationId].get.ts
  - test/integration/acceptance-tc-13.test.ts
-->
