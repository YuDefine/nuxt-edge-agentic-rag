...
| TD-004 | 首頁 Google login button 高度 36px < WCAG 40px         | high     | open   | B17 viewport-baseline.spec.ts | —     |
| TD-005 | Admin 頁面 a11y violations 批次（@nuxt/a11y 首輪掃描） | high     | open   | 2026-04-21 RAF @nuxt/a11y     | —     |
