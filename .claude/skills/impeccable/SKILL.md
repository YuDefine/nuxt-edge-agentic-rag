...
Then ask the user directly to clarify what you cannot infer. Keep the Design Context in `.impeccable.md`; do not duplicate it into generated projection files.
